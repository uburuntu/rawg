...
class TagsApi(object):
    ...
    def tags_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TagsList200Response, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def tags_read(self, id, **kwargs):  # noqa: E501
        """Get details of the tag.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tags_read(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.tags_read_with_http_info(id, **kwargs)  # noqa: E501

    def tags_read_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get details of the tag.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tags_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TagSingle, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tags_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and local_var_params.get('id') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `tags_read`")  # noqa: E501
