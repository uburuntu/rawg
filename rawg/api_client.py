...
import rawg.models
from rawg import rest
from rawg.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'https://github.com/uburuntu/rawg'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(rawg.models, klass)
    ...
    def update_params_for_auth(self, headers, queries, auth_settings,
        ...
        """
        if 'key' not in self.configuration.api_key:
            raise ApiException(
                'You must provide API key in Configuration: '
                'rawg.ApiClient(rawg.Configuration(api_key={"key": "YOUR_API_KEY"}))'
            )

        queries.append(('key', self.configuration.api_key['key']))
