...
import rawg
from rawg.models.youtube import Youtube  # noqa: E501
from rawg.rest import ApiException

class TestYoutube(unittest.TestCase):
    """Youtube unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = rawg.models.youtube.Youtube()  # noqa: E501
        if include_optional :
            return Youtube(
                id = 56, 
                external_id = '0', 
                ...
                dislike_count = 56, 
                favorite_count = 56, 
                thumbnails = rawg.models.thumbnails.Thumbnails()
            )
        else :
            return Youtube(
        )
