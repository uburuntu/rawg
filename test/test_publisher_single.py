...
import rawg
from rawg.models.publisher_single import PublisherSingle  # noqa: E501
from rawg.rest import ApiException

class TestPublisherSingle(unittest.TestCase):
    """PublisherSingle unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PublisherSingle
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = rawg.models.publisher_single.PublisherSingle()  # noqa: E501
        if include_optional :
